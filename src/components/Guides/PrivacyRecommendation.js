...
const PrivacyRecommendation = () => {
  return(
    <Fragment>
      <h2>My browser privacy setup recommendation</h2>          
        <ul>
          <li><b>Use a more privacy-focused browser.</b> I currently use <a className="link-dark" href="https://www.mozilla.org/en-CA/firefox/new/">Firefox</a>. (If you use Firefox,
          ...
          <li><b>Install the <a className="link-dark" href="https://chrome.google.com/webstore/detail/ghostery-%E2%80%93-privacy-ad-blo/mlomiejdfkolichcflejclcbmpeaniij">Ghostery</a> web extension.</b> It will help block a lot of trackers, and reduce the number of annoying cookie banner.</li>
          
          <li><b>Install the <a className="link-dark" href="https://addons.mozilla.org/en-US/firefox/addon/multi-account-containers/">containers</a> extension </b>, 
            and <a className="link-dark" href="https://support.mozilla.org/en-US/kb/how-use-firefox-containers">set it up</a> according to your internet
            ...
            <li><b>Change the default search engine to DuckDuckGo.</b> For day-to-day browsing, DuckDuckGo should be satisfactory. When doing advanced research, it might be useful to use Google as its search results are still better.</li>
          ...
          <p>These guides are intended for friends and family who may want to adapt their web setup. 
            ...
            Many thanks to <a className="link-dark" href="https://sunknudsen.com/">Sun Knudsen</a>; 
            his great Youtube channel piqued my interest concerning web privacy and security, 
            and a lot of my set up is based on his.</p>

        <h5>Do you absolutely want to keep using Google Chrome? (Not recommended)</h5>
          <ul>
            <li>Consider using a different web browser</li>
            <li>Install the <a className="link-dark" href="https://chrome.google.com/webstore/detail/ghostery-%E2%80%93-privacy-ad-blo/mlomiejdfkolichcflejclcbmpeaniij">Ghostery</a> web extension. It will help block a lot of trackers, and reduce the number of annoying cookie banner.</li>
            ...
            <li>Stop using Google Chrome and use a privacy-focused browser ;) </li>
          </ul>
  </Fragment>
  )
}
